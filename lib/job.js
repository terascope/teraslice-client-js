...
class Job {
    constructor(config, jobId) {
        ...
        this._request = newRequest(config);
        this._jobId = this._jobId;
    }

    id() { return this._jobId; }

    slicer() {
        return this._request.get(`/jobs/${this._jobId}/slicer`);
    }
    ...
    ex() {
        return this._request.get(`/jobs/${this._jobId}/ex`)
    ...
    spec() {
        return this._request.get(`/jobs/${this._jobId}`);
    }

    errors() {
        return this._request.get(`/jobs/${this._jobId}/errors`);
    }
    ...
    _filterProcesses(role) {
        return this._request.get('/cluster/state')
            .then((state) => {
